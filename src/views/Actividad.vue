  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5   
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Identificando el paso a paso en los PAP
        p.mb-4 Apropiar las fases de la aplicación de los PAP.
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Completar definiciones
            .col-auto
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Estrategias de adaptación de afrontamiento
        p.mb-4 Comprender que los recursos individuales de afrontamiento son la base del equilibrio emocional.
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
